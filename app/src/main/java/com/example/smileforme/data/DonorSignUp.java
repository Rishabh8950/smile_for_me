...
import com.example.smileforme.DonorDBFragment;
import com.example.smileforme.DonorLogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signinbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"Password can contain only alphabets and numbers",
                ...
                else if(!pwd.getText().toString().equals(re_pwd.getText().toString()))
                {
                    ...
                    donordb.insertintodonor(name.getText().toString(),dob.getText().toString(),gen,mail.getText().toString(),
                            mobile.getText().toString(),pwd.getText().toString());
                    Intent enter=new Intent(getApplicationContext(), DonorLogin.class);
                    startActivity(enter);
                }
