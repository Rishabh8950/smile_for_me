...
import com.example.smileforme.RecipientSignup;

import static org.junit.Assert.*;

public class RecipientSignupTest {

	RecipientSignup object = new RecipientSignup();
	...
	@Test
	public void BPLValidator_CorrectBPL_ReturnsTrue() {
	    assertEquals(true, object.validateBpl("9876543210"));
	}
	
	@Test
	public void BPLValidator_IncorrectBPLLessDigit_ReturnsFalse() {
	    assertEquals(false, object.validateBpl("98210"));
	}
	
	@Test
	public void BPLValidator_IncorrectBPLMoreDigit_ReturnsFalse() {
	    assertEquals(false, object.validateBpl("9876543210000"));
	}
	
	@Test
	public void BPLValidator_IncorrectBPLAlphabet_ReturnsFalse() {
	    assertEquals(false, object.validateBpl("abcde210000"));
	}
}
